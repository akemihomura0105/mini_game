...
state_code Actionable_character::attack(Actionable_character& character)
{
	state_code sc;
	if (!action_flag)
	{
...
state_code Actionable_character::treasure_hunt()
{
...
state_code Actionable_character::move(int target_location)
{
	state_code sc;
	if (!action_flag)
	{
...
state_code Actionable_character::heal(Actionable_character& character)
{
	state_code sc;
	if (!action_flag)
	{
...
state_code Evil_spirit::attack(Actionable_character& character)
{
	state_code sc;
	if (!skill_charge_num)
	{
